...
firebaseConfig={
  ...
  'apiKey': "AIzaSyCLpKLK0-xh8DWJ9dvlo2HA0otZ5F9i9BA",
  'authDomain': "appkivy-ca185.firebaseapp.com",
  'databaseURL': "https://appkivy-ca185-default-rtdb.firebaseio.com",
  'projectId': "appkivy-ca185",
  'storageBucket': "appkivy-ca185.appspot.com",
  'messagingSenderId': "805506930792",
  'appId': "1:805506930792:web:43fa0c4c56ea501cf483dd",
  'measurementId': "G-8WTX04TK9W"
...
def create_post(self, nome, cpf, senha):
  firebase_url = "https://appkivy-ca185-default-rtdb.firebaseio.com/Users/.json"
  auth_key = 'U37KTnydKtAsWYIH1GjOXpxNs0iG7XtU90Z1gv4o'
  ...
  try:        
    ...
    if nome == "":
      ...
      self.ids.lbregister.text = "Senha precisa de pelo menos 7 caracteres"
...
def redf_passwd(self, cpf, senha):
  ...
  if cpf == "":
    ...
    self.ids.lbredfsenha.text = "Senha precisa ter pelo menos 7 caracteres"
...
def show_data_picker(self):
  date_dialog = MDDatePicker(day=1, month=1, year=2024)
...
def check(self, especialidade, data, paciente):
  firebase_url = "https://appkivy-ca185-default-rtdb.firebaseio.com/Pacients/.json"
  firebase_url2 = "https://appkivy-ca185-default-rtdb.firebaseio.com/Schedule/Consulta/.json"
  ...
  if especialidade == "":
    ...
    to_database = '{"Exercício": 'f'{json.dumps(especialidade)}'', "Data": 'f'{json.dumps(data)}'', "CPF do aluno": 'f'{json.dumps(paciente)}''}'
    db = firebase2.database()
    ...
    try:
      ...
      requests.post(url = self.firebase_url, json = json.loads(to_database))
      self.ids.lbcheckin.text = "Treino salvo com sucesso!"
...
def checkout(self, med, data, paciente2):
  firebase_url = "https://appkivy-ca185-default-rtdb.firebaseio.com/Pacients/.json"
  firebase_url2 = "https://appkivy-ca185-default-rtdb.firebaseio.com/Schedule/Consulta/.json"
  firebase_url3 = "https://appkivy-ca185-default-rtdb.firebaseio.com/Meds/.json"
  auth_key = 'U37KTnydKtAsWYIH1GjOXpxNs0iG7XtU90Z1gv4o'
...
def create_post_meds(self, nome_med, quantidade, id_med):
  firebase_url = "https://appkivy-ca185-default-rtdb.firebaseio.com/Meds/.json"
  auth_key = 'U37KTnydKtAsWYIH1GjOXpxNs0iG7XtU90Z1gv4o'
  request = requests.get(self.firebase_url + '?auth=' + self.auth_key)
  res = json.dumps(request.json()) 
...
def load_data(self, *args): 
  get_request = requests.get(f'https://appkivy-ca185-default-rtdb.firebaseio.com/Meds/.json')
...
def create_post_pacient(self, nome2, cpf2, senha2):
  ...
  try:        
    ...
    if len(cpf2) != 11:
      ...
      self.ids.lbregister_pacient.text = "Senha precisa de pelo menos 7 caracteres"
...
def load_data2(self, *args): 
  get_request = requests.get(f'https://appkivy-ca185-default-rtdb.firebaseio.com/Schedule/Consulta/.json')
  consultas_data = json.loads(get_request.content.decode())
...
def load_data3(self, *args): 
  get_request = requests.get(f'https://appkivy-ca185-default-rtdb.firebaseio.com/Schedule/Retirada/.json')
  consultas_data = json.loads(get_request.content.decode())
...
def load_data4(self, *args): 
  firebase_url = "https://appkivy-ca185-default-rtdb.firebaseio.com/Users/Duty/.json"
  auth_key = 'U37KTnydKtAsWYIH1GjOXpxNs0iG7XtU90Z1gv4o'
  if HORARIOS_SELECIONADOS:
    for h_horarios in HORARIOS_SELECIONADOS:
      post_request = requests.delete(f'https://appkivy-ca185-default-rtdb.firebaseio.com/Users/Duty/{h_horarios}/.json')

  get_request = requests.get(f'https://appkivy-ca185-default-rtdb.firebaseio.com/Users/Duty/.json')
...
def load_data5(self, *args): 
  get_request = requests.get(f'https://appkivy-ca185-default-rtdb.firebaseio.com/Pacients/.json')
